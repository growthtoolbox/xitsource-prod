          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="md:col-span-1 border-t md:border-t-0 md:border-l border-[#1a1a1a] pt-12 md:pt-0 md:pl-12">
              <div className="mt-6 pt-6 border-t border-[#1a1a1a]">
                <a href="https://GrowthToolBox.app" target="_blank" rel="noopener noreferrer" className="block w-full py-4 px-6 bg-[#52D017]/10 border border-[#52D017] text-[#52D017] font-semibold text-center rounded-sm hover:bg-[#52D017] hover:text-black transition-colors">
                  GrowthToolBox.app
                </a>
              </div>
            </div>
