        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="md:col-span-2 space-y-8 text-slate-300 leading-relaxed text-lg">
              ...
              <h3 className="text-2xl font-semibold text-slate-200 mt-12 mb-4">Strategic Digital Deployment</h3>
              <p>
            ...
            <div className="md:col-span-1 border-t md:border-t-0 md:border-l border-[#1a1a1a] pt-12 md:pt-0 md:pl-12">
              <h4 className="text-sm font-semibold tracking-widest text-slate-500 uppercase mb-6">Execution Pillars</h4>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-slate-400">Technical SEO frameworks emphasizing speed and AI-engine visibility (AEO).</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Organic and paid strategies designed to capture local California market share.</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Digital acceleration directly linked to improving eventual exit multiples.</p>
                </div>
              </div>
