  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 pb-32 space-y-16">
      ...
      <header className="space-y-4 border-b border-gray-800 pb-8">
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-white">Privacy Policy & California Disclosures</h1>
        <p className="text-gray-400 text-lg">Last Updated: March 14, 2026</p>
        <div className="inline-flex items-center gap-2 px-3 py-1.5 border border-cyan-500/30 rounded-sm bg-cyan-500/10 text-cyan-400 text-sm font-medium">
           CCPA / CPRA Compliant Notice
        </div>
      </header>

      <section className="space-y-6">
        <h2 className="text-2xl font-semibold text-white">Notice at Collection</h2>
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-semibold text-white">Categories of Data Collected</h2>
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-semibold text-white">AI Interaction Disclosure (SB 1001)</h2>
        <div className="border border-gray-800 bg-[#0a0a0a] p-6 rounded-sm">
          ...
          <p className="text-cyan-400 text-sm font-mono border-l-2 border-cyan-500 pl-4">
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-semibold text-white" id="california-choices">Your California Privacy Rights</h2>
        <p className="text-gray-300 leading-relaxed mb-4">
      ...
      <section className="space-y-6 relative" id="do-not-sell">
        <div className="absolute -left-4 top-0 w-1 h-full bg-cyan-500/50 rounded-full hidden md:block"></div>
        <h2 className="text-2xl font-semibold text-white">Do Not Sell or Share My Personal Information</h2>
        <p className="text-gray-300 leading-relaxed">
        ...
        <div className="mt-8">
          <button className="px-6 py-3 bg-[#0a0a0a] border border-gray-700 hover:border-cyan-500 text-white rounded-sm transition-colors text-sm font-medium">
            Opt-Out of Data Sharing
          </button>
        </div>
      </section>
      
      <div className="pt-12 text-sm text-gray-500 border-t border-gray-800">
