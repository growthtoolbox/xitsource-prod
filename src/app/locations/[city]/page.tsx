  ...
  return (
    <div className="min-h-screen bg-[#050505] text-gray-200 py-24">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-5xl text-center">
        ...
        <div className="bg-[#0a0a0a] border border-[#1a1a1a] p-8 md:p-12 mt-12 mb-16 rounded-sm max-w-4xl mx-auto shadow-2xl relative overflow-hidden">
           <div className="absolute top-0 left-0 w-1 h-full bg-[#52D017]"></div>
           <p className="text-xl text-slate-300 leading-relaxed font-serif mb-8">
           ...
           <div className="text-left bg-[#161616] border border-[#1a1a1a] p-6 rounded-sm">
             <div className="text-sm font-bold uppercase tracking-widest text-[#52D017] mb-2">Regional Context</div>
             <p className="text-slate-400 capitalize">{regionContext}</p>
           </div>
        </div>
        
        {/* Expert feature */}
        <div className="max-w-3xl mx-auto text-left bg-[#0a0a0a] border border-[#1a1a1a] p-8 flex flex-col md:flex-row items-center gap-6 mb-16 rounded-sm group hover:border-[#52D017]/50 transition-colors">
          <div className="w-24 h-24 bg-[#161616] rounded-full border border-[#1a1a1a] flex-shrink-0 flex items-center justify-center overflow-hidden">
            <span className="text-3xl text-slate-600 font-bold group-hover:text-[#52D017] transition-colors">{expert.initials}</span>
          </div>
          <div>
            <h3 className="text-2xl font-bold text-slate-200 mb-1">{expert.name}</h3>
            <p className="text-[#52D017] text-sm uppercase tracking-widest font-semibold mb-3">{expert.role}</p>
            <p className="text-slate-400 text-sm leading-relaxed">{expert.desc}</p>
          </div>
        </div>
