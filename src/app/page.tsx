          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-[#0a0a0a] border border-[#1a1a1a] p-8 flex flex-col items-center text-center group hover:border-[#52D017]/50 transition-colors">
              ...
              <div className="flex items-center gap-4 mt-auto">
                ...
                <a href="mailto:contact@xitsource.com" className="p-2 border border-[#1a1a1a] rounded hover:border-[#52D017] hover:text-[#52D017] text-slate-400 transition-colors" title="Direct Email">
