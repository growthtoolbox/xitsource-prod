        ...
        <section className="container mx-auto px-6 pt-24 pb-16 md:pt-32 md:pb-20 flex flex-col items-center justify-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
             <div className="flex flex-col items-center">
               ...
               <Link href="/resources" className="mt-8 text-sm font-semibold text-[#111827] hover:text-[#52D017] transition-colors underline decoration-[#52D017]/50 underline-offset-4">Prefer to learn first? Explore our guides.</Link>
             </div>
          </div>
