  ...
  return (
    <div className="container mx-auto px-6 py-24 md:py-32 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none prose-p:leading-relaxed prose-p:text-[#111827]">
        ...
        <h3 className="text-2xl font-bold text-[#111827] mt-12 mb-4">Lease Control is Everything</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold text-[#111827] mt-12 mb-4">The Equipment Audit</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold text-[#111827] mt-12 mb-4">Proving the Cash</h3>
        <p>
