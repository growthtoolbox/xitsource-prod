  ...
  return (
    <div className="container mx-auto px-6 py-24 md:py-32 max-w-4xl">
      ...
      <div className="prose prose-invert prose-lg max-w-none prose-p:leading-relaxed prose-p:text-slate-300">
        ...
        <h3 className="text-2xl font-bold text-slate-200 mt-12 mb-4">1. The Lease is the Asset</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold text-slate-200 mt-12 mb-4">2. Equipment Age & Utility Analysis</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold text-slate-200 mt-12 mb-4">3. Proving the Cash</h3>
        <p>
