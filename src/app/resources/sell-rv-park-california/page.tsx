  ...
  return (
    <div className="container mx-auto px-6 py-24 md:py-32 max-w-4xl bg-white text-slate-900">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-1 gap-4 md:h-[400px]">
           <div className="h-32 md:h-[192px] w-full overflow-hidden rounded-sm relative group">
             <img src="https://images.unsplash.com/photo-1478147424043-b0eec8216fcb?auto=format&fit=crop&q=80&w=600" alt="High-yield RV Park property detail in Northern California" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
           </div>
           <div className="h-32 md:h-[192px] w-full overflow-hidden rounded-sm relative group">
             <img src="https://images.unsplash.com/photo-1571120037160-5a9b9a473da6?auto=format&fit=crop&q=80&w=600" alt="High-yield investment interior detail in Northern California" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
           </div>
        </div>
      </div>
      ...
      <div className="prose prose-lg max-w-none prose-p:leading-relaxed prose-p:text-slate-900">
        ...
        <h3 className="text-2xl font-bold text-slate-900 mt-12 mb-4">1. Capital Expenditure (CapEx) & Deferred Maintenance</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold text-slate-900 mt-12 mb-4">2. Long-Term Occupancy vs. Transient Income</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold text-slate-900 mt-12 mb-4">3. The Off-Market Advantage</h3>
        <p>
