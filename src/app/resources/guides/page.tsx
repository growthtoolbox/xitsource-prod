      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="mt-24 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Link href="/markets/huntsville-al" className="bg-[#fcfcfc] border border-gray-200 hover:border-[#52D017] p-8 rounded-sm group transition-all duration-300 hover:shadow-xl hover:shadow-black/5 flex flex-col h-full relative block cursor-pointer">
            ...
            <Link href="/markets/savannah-ga" className="bg-[#fcfcfc] border border-gray-200 hover:border-[#52D017] p-8 rounded-sm group transition-all duration-300 hover:shadow-xl hover:shadow-black/5 flex flex-col h-full relative block cursor-pointer">
            ...
            <Link href="/markets/phoenix-az" className="bg-[#fcfcfc] border border-gray-200 hover:border-[#52D017] p-8 rounded-sm group transition-all duration-300 hover:shadow-xl hover:shadow-black/5 flex flex-col h-full relative block cursor-pointer">
            ...
            <Link href="/markets/austin-tx" className="bg-[#fcfcfc] border border-gray-200 hover:border-[#52D017] p-8 rounded-sm group transition-all duration-300 hover:shadow-xl hover:shadow-black/5 flex flex-col h-full relative block cursor-pointer">
            ...
            <Link href="/markets/dallas-tx" className="bg-[#fcfcfc] border border-gray-200 hover:border-[#52D017] p-8 rounded-sm group transition-all duration-300 hover:shadow-xl hover:shadow-black/5 flex flex-col h-full relative block cursor-pointer">
              <h3 className="text-xl font-bold text-[#111827] mb-2">DFW, TX</h3>
              <p className="text-gray-600 text-sm mb-4 flex-grow">The National Logistics Anchor</p>
              <span className="text-[#52D017] text-sm font-bold flex items-center mt-auto group-hover:underline">View Profile →</span>
            </Link>
            <Link href="/markets/greenville-sc" className="bg-[#fcfcfc] border border-gray-200 hover:border-[#52D017] p-8 rounded-sm group transition-all duration-300 hover:shadow-xl hover:shadow-black/5 flex flex-col h-full relative block cursor-pointer">
            ...
            <Link href="/markets/chattanooga-tn" className="bg-[#fcfcfc] border border-gray-200 hover:border-[#52D017] p-8 rounded-sm group transition-all duration-300 hover:shadow-xl hover:shadow-black/5 flex flex-col h-full relative block cursor-pointer">
              <h3 className="text-xl font-bold text-[#111827] mb-2">Chattanooga, TN</h3>
              <p className="text-gray-600 text-sm mb-4 flex-grow">Infrastructure & Gig-City</p>
              <span className="text-[#52D017] text-sm font-bold flex items-center mt-auto group-hover:underline">View Profile →</span>
            </Link>
            <Link href="/markets/tampa-fl" className="bg-[#fcfcfc] border border-gray-200 hover:border-[#52D017] p-8 rounded-sm group transition-all duration-300 hover:shadow-xl hover:shadow-black/5 flex flex-col h-full relative block cursor-pointer">
              <h3 className="text-xl font-bold text-[#111827] mb-2">Florida</h3>
