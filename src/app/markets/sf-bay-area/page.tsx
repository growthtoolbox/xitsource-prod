...
export default function SFBayAreaMarket() {
  return (
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="mb-12 border-b border-gray-200 pb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-[#111827] mb-6">
            San Francisco Bay Area Multifamily
          </h1>
          <p className="text-xl text-[#111827] leading-relaxed mb-6">
            Our strategy in the Bay Area is focused exclusively on AI-driven recovery and the repurposing of highly strategic assets across supply-constrained submarkets.
          </p>
          <div className="mt-8 bg-[#F9FAFB] border-l-4 border-[#52D017] p-6 rounded-r-sm">
            ...
            <p className="text-lg text-[#111827]/80 italic">
              &quot;Our boots on the ground in SoMa and Mission Bay confirm what the headlines miss: the structural tech recovery is accelerating, creating extremely tight supply windows right now for operators willing to move fast.&quot;
            </p>
          </div>
        </div>
