...
export const metadata: Metadata = {
  title: 'San Francisco Bay Area Multifamily: The AI Recovery | XitSource',
  description: 'The Bay Area is entering a structural recovery phase in 2026. Driven by an 11% surge in downtown office-to-lab conversions for AI startups, we are see...',
};

export default function SFBayAreaMarketPage() {
  return (
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-8 mb-20 text-lg">
          <div>
            ...
            <p className="leading-relaxed font-medium">
              Value-add repositioning of vintage Class B assets to meet the standards of the world&apos;s highest-earning tech workforce.
            </p>
          </div>
        </div>
