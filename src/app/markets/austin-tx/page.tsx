...
export const metadata: Metadata = {
  title: 'Austin Multifamily: The Silicon Hills Turnaround | XitSource',
  description: 'After 10 quarters of rent declines, Austin is poised for a 2026 turnaround. As deliveries pull back (dropping below 10k units), demand is projected to...',
};
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="mb-12 border-b border-gray-200 pb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-[#111827] mb-6">
            Austin Multifamily: The Silicon Hills Turnaround
          </h1>
          <p className="text-xl text-[#111827] leading-relaxed max-w-3xl">
            After 10 quarters of rent declines, Austin is poised for a 2026 turnaround. As deliveries pull back (dropping below 10k units), demand is projected to jump to 19k units. We focus on the Tesla Giga-Factory corridor, where the infrastructure and workforce are firmly rooted.
          </p>
        </div>
