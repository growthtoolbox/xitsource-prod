...
export default function SavannahMarket() {
  return (
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="mb-12 border-b border-gray-200 pb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-[#111827] mb-6">
            Savannah, GA Multifamily
          </h1>
          <p className="text-xl text-[#111827] leading-relaxed mb-6">
            Leveraging the $4.5B Port expansion and the massive Hyundai Metaplant to provide housing for exponential job growth.
          </p>
          <div className="mt-8 bg-[#F9FAFB] border-l-4 border-[#52D017] p-6 rounded-r-sm">
            ...
            <p className="text-lg text-[#111827]/80 italic">
              &quot;Directly assessing the impacts of the Hyundai Metaplant, it\&apos;s clear the housing supply is trailing the exponential job growth. That\&apos;s exactly where we want to deploy our capital.&quot;
            </p>
          </div>
        </div>
