...
export const metadata: Metadata = {
  title: 'Savannah Multifamily: Port-Driven Performance | XitSource',
  description: 'Anchored by the Port of Savannah (5.7M TEUs) and the Hyundai Metaplant, the region is a global logistics powerhouse. The Georgia Ports Authority\'s $5B...',
};

export default function SavannahMarketPage() {
  return (
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="mb-12 border-b border-gray-200 pb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-[#111827] mb-6">
            Savannah Multifamily: Port-Driven Performance
          </h1>
          <p className="text-xl text-[#111827] leading-relaxed max-w-3xl">
            Anchored by the Port of Savannah (5.7M TEUs) and the Hyundai Metaplant, the region is a global logistics powerhouse. The Georgia Ports Authority&apos;s $5B infrastructure plan is creating a permanent renter class of logistics professionals that is decoupled from general consumer trends.
          </p>
        </div>
