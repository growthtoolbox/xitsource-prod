...
export const metadata: Metadata = {
  title: 'Florida Multifamily: The Migration-Led Boom | XitSource',
  description: 'Florida dominates 8 of the top 10 metros for migration growth in 2026. Population growth—not historical prominence—is the driver. Tampa and Jacksonvil...',
};
