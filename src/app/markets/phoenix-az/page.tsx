...
export default function PhoenixMarket() {
  return (
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="mb-12 border-b border-gray-200 pb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-[#111827] mb-6">
            Phoenix, AZ Multifamily
          </h1>
          <p className="text-xl text-[#111827] leading-relaxed mb-6">
            Positioning strictly inside the $65B TSMC Semiconductor corridor, focusing on workforce housing catering to the explosion of advanced manufacturing jobs.
          </p>
          <div className="mt-8 bg-[#F9FAFB] border-l-4 border-[#52D017] p-6 rounded-r-sm">
            ...
            <p className="text-lg text-[#111827]/80 italic">
              &quot;Touring the outer loops near the TSMC site, you immediately realize the massive housing shortfall for advanced manufacturing workers. That\&apos;s the exact gap our capital is meant to fill.&quot;
            </p>
          </div>
        </div>
