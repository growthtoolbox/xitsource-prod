...
export default function GreenvilleMarket() {
  return (
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="mb-12 border-b border-gray-200 pb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-[#111827] mb-6">
            Greenville, SC Multifamily
          </h1>
          <p className="text-xl text-[#111827] leading-relaxed mb-6">
            Focused on the booming I-85/BMW Automotive corridor, acquiring value-add properties that serve rapid regional industrialization.
          </p>
          <div className="mt-8 bg-[#F9FAFB] border-l-4 border-[#52D017] p-6 rounded-r-sm">
            ...
            <p className="text-lg text-[#111827]/80 italic">
              &quot;When visiting the I-85 stretch, the density of automotive tier-one suppliers is incredible. That persistent growth creates an unparalleled opportunity for value-add housing.&quot;
            </p>
          </div>
        </div>
