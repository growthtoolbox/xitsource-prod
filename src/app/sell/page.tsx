      ...
      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-12">
            <div>
              <h2 className="text-2xl font-bold text-[#111827] mb-6 border-l-4 border-[#52D017] pl-4">Why Go Off-Market?</h2>
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="text-[#52D017] font-bold text-xl">01</div>
                  <div>
                    <h3 className="text-lg font-semibold text-[#111827] mb-2">Strict Confidentiality</h3>
                    <p className="text-[#111827] leading-relaxed">Your employees, tenants, and competitors don&apos;t need to know your business until the deal is done. Public listings create chaos; private sales create certainty.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="text-[#52D017] font-bold text-xl">02</div>
                  <div>
                    <h3 className="text-lg font-semibold text-[#111827] mb-2">No Broker Fees</h3>
                    <p className="text-[#111827] leading-relaxed">Traditional sales cost you 6-10% of your equity. Because we acquire directly with our own capital, you keep what you&apos;ve built.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="text-[#52D017] font-bold text-xl">03</div>
                  <div>
                    <h3 className="text-lg font-semibold text-[#111827] mb-2">Legacy Protection</h3>
                    <p className="text-[#111827] leading-relaxed">We honor the work you&apos;ve put into your assets and look to build upon it. We prioritize operational continuity where it matters most.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 p-8 rounded-sm">
              <h3 className="text-xl font-bold text-[#111827] mb-4">Not Sure If You&apos;re Ready?</h3>
              <p className="text-[#111827] mb-6">Take our Seller Readiness Scorecard to evaluate your transition timeline.</p>
              <Link href="/scorecard" className="inline-block px-6 py-3 bg-transparent border border-[#52D017] text-[#52D017] hover:bg-[#52D017] hover:text-[#111827] transition-colors rounded-sm font-semibold">
          ...
          {/* Acquisition Form */}
          <div id="contact-form" className="bg-white border border-gray-200 p-8 md:p-12 relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#52D017]/20 via-[#52D017] to-[#52D017]/20"></div>
            
            <h2 className="text-2xl font-bold text-[#111827] mb-4">Request a Confidential Conversation</h2>
            <p className="text-[#111827] mb-8">Reach out to discuss your business transition or real estate goals. John and Ryan personally review all inquiries.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button 
                ...
                className="w-full bg-[#52D017] text-[#111827] font-semibold rounded-sm py-4 hover:bg-[#45b312] transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-lg"
              >
