...
export default function QuickFAQ() {
  ...
  return (
    <section className="container mx-auto px-6 py-24 border-t border-[#1a1a1a]/50">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-slate-200 mb-4">Frequently Asked Questions</h2>
          <p className="text-slate-400">Common questions regarding our direct acquisition process.</p>
        </div>
        ...
        <div className="space-y-4 mb-10">
          {quickFaqData.map((faq, idx) => {
            ...
            return (
              <div key={idx} className={`border rounded-sm transition-colors overflow-hidden ${isOpen ? 'border-[#52D017] bg-[#52D017]/5' : 'border-[#1a1a1a] bg-[#0a0a0a] hover:border-gray-600'}`}>
                <button 
        ...
        <div className="text-center">
           <Link href="/faq" className="text-sm font-semibold text-[#52D017] hover:text-white transition-colors tracking-widest uppercase">
              View All FAQs →
           </Link>
        </div>
      </div>
